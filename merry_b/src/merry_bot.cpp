...
namespace merry_bot{
        ...
        ui(new Ui::merry_bot)
    {
        ...
        merry_bot::start = 1;
        cout << "start:" << merry_bot::start << endl;
        qnode.start_msg_.pushcheck = merry_bot::start;
        qnode.send_start();
    }
...
// void merry_bot::merry_bot::pub_donation_start()
// {
//     merry_bot::start = 1;
//     cout << "start:" << merry_bot::start << endl;
//     qnode.start_msg_.pushcheck = merry_bot::start;
...
void merry_bot::merry_bot::on_pushButton_clicked()
{
    ...
    qnode.button_msg_.pushcheck = merry_bot::pushed;
    qnode.send_pushed();
