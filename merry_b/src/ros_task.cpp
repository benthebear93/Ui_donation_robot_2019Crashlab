...
namespace merry_bot{
    ...
    void ros_task::init_nh()
      {
        ...
        button_pub = nh->advertise<merry_b::TaskCommand>("/ui_merry/button_msg_", 10);
        start_pub = nh->advertise<merry_b::TaskCommand>("/ui_meery/start_msg_", 10);
    ...
    {
      button_pub.publish(button_msg_);
    }
    void ros_task::send_start()
    {
