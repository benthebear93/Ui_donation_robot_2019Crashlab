...
if __name__ == '__main__':
    ...
    v_media1 = vocal1.media_new(out['vocal_list'][0])

    vocal2 = vlc.Instance()
    v_player2 = vocal2.media_player_new()
    v_media2 = vocal2.media_new(out['vocal_list'][1])

    vocal3 = vlc.Instance()
    v_player3 = vocal3.media_player_new()
    v_media3 = vocal3.media_new(out['vocal_list'][2])

    vocal4 = vlc.Instance()
    v_player4 = vocal4.media_player_new()
    v_media4 = vocal4.media_new(out['vocal_list'][3])
